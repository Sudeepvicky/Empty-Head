          ...
          <section id="signin" class="container mt-2">
            ...
            <form action="/Trainee_login" method="post">
              <div class="form-group mt-2">
                <input type="text" class="form-control" id="email" placeholder="Enter username" required name="trainee_login_email">
              </div>
        ...
        <div id="Trainer-login" style="display: none;"> 
          <section id="signin" class="container mt-2">
            ...
            <form action="/Trainer_login" method="post"> 
              <div class="form-group mt-2">
                <input type="text" class="form-control" id="email" placeholder="Enter username" required name="trainer_login_email">
              </div>
              <!-- <div class="form-group mt-2">
